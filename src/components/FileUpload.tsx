  ...
  return (
    <div className="bg-white p-8 rounded-[2rem] border-2 border-gray-50 shadow-sm">
      ...
      <button
        ...
        className="w-full mt-6 bg-[#3F2171] text-white py-4 rounded-xl font-black shadow-lg hover:shadow-green-900/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {uploading ? (
          <>
