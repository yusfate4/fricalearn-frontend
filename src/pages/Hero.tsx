...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-[#0E1C0E] min-h-screen flex items-center overflow-hidden pt-24 pb-16">
      {/* Background decorations */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full opacity-10"
        style={{ background: "radial-gradient(circle, #2D5A27, transparent 70%)", transform: "translate(30%,-30%)" }}/>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-10"
        style={{ background: "radial-gradient(circle, #F4B400, transparent 70%)", transform: "translate(-30%,30%)" }}/>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-3 bg-[#F4B400] rounded-full pl-2 pr-5 py-2 mb-8 animate-in fade-in slide-in-from-bottom duration-500">
              <span className="bg-[#0E1C0E] text-[#F4B400] text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full">
                New
              </span>
              <span className="text-[#0E1C0E] text-[11px] font-black uppercase tracking-widest">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white uppercase italic tracking-tighter leading-[0.95] mb-6">
              World-Class<br/>
              Education For<br/>
              <span className="text-[#F4B400]">African Children.</span>
            </h1>
            ...
            <p className="text-white/60 font-medium text-base md:text-lg leading-relaxed max-w-xl mb-4">
              ...
              curriculum aligned — <strong className="text-[#F4B400]">free for 14 days</strong>.
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              {[
                ...
                <span key={b.label} className="flex items-center gap-2 bg-white/5 border border-white/10 text-white/70 text-[10px] font-black uppercase tracking-widest px-4 py-2.5 rounded-xl">
                  <span className="text-[#F4B400]">{b.icon}</span> {b.label}
                </span>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <button onClick={() => navigate("/register")}
                className="bg-[#F4B400] text-[#0E1C0E] px-10 py-6 rounded-[2rem] font-black text-base uppercase italic tracking-tight flex items-center justify-center gap-3 hover:scale-105 transition-all shadow-2xl border-b-4 border-yellow-600 active:translate-y-1 active:border-b-0">
          ...
          <div className="relative hidden lg:block">
            <div className="bg-gradient-to-br from-[#2D5A27] to-[#1a3318] rounded-[3rem] p-12 relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 text-center py-16">
                ...
                <p className="text-white font-black text-2xl uppercase italic tracking-tight leading-tight">
                  ...
                  <span className="text-[#F4B400]">Every heritage lives.</span>
                </p>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -left-8 bg-white rounded-3xl px-7 py-5 shadow-2xl animate-in slide-in-from-left duration-700">
              <p className="text-3xl font-black text-[#2D5A27] italic">3,000+</p>
            ...
            <div className="absolute -bottom-6 -right-4 bg-white rounded-3xl px-7 py-5 shadow-2xl animate-in slide-in-from-right duration-700">
              <p className="text-3xl font-black text-[#F4B400] italic">14 Days</p>
