...
const steps = [
  {
    ...
    desc: "Paying in Naira? You get the Nigerian (NERDC) curriculum. Paying in Pounds? You get the UK National Curriculum. Both include free African languages.",
    color: "bg-[#F4B400]",
  ...
  },
  {
    ...
    desc: "Access lessons immediately after payment. Watch videos on Oak Academy, take quizzes, earn points, and chat with Olụkọ AI — all in one place.",
    color: "bg-[#0E1C0E]",
    textColor: "text-white",
  },
];
