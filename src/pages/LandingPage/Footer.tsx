...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#2A1650] text-white pt-20 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3">
              <a href="https://www.instagram.com/fricalearn/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="p-2.5 bg-white/10 border border-white/10 rounded-xl hover:bg-[#3F2171] transition-colors">
                <FaInstagram size={16} />
              </a>
          ...
          {/* Column 2: Platform */}
          <div>
            <h4 className="text-[#FFFF00] font-black text-[10px] uppercase tracking-widest mb-6">Platform</h4>
          ...
          {/* Column 3: Learning */}
          <div>
            <h4 className="text-[#FFFF00] font-black text-[10px] uppercase tracking-widest mb-6">Learning</h4>
            <ul className="space-y-4 text-sm text-white/60 font-bold">
              <li>Mathematics</li>
              <li>English</li>
          ...
          {/* Column 4: Contact */}
          <div>
            <h4 className="text-[#FFFF00] font-black text-[10px] uppercase tracking-widest mb-6">Contact</h4>
            <ul className="space-y-4 text-sm text-white/60 font-bold">
              <li className="flex items-start gap-3">
                <FaEnvelope className="mt-1 text-[#3F2171] shrink-0" />
              ...
              <li className="flex items-start gap-3">
                <FaMapMarkerAlt className="mt-1 text-[#3F2171] shrink-0" />
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-xs text-white/40 gap-4">
          <p className="font-bold">
            ...
            <a href="https://hikishdigital.com.ng/" target="_blank" rel="noopener noreferrer"
              className="text-[#FFFF00] hover:text-white transition-colors font-black underline underline-offset-4 decoration-white/20">
              The Hikish Digitals
            </a>.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-6">
            <Link to="/terms" className="font-black text-[10px] uppercase tracking-widest hover:text-[#FFFF00] transition-colors">
              Terms of Service
            </Link>
            <Link to="/privacy" className="font-black text-[10px] uppercase tracking-widest hover:text-[#FFFF00] transition-colors">
              Privacy Policy
            </Link>
            <Link to="/cookies" className="font-black text-[10px] uppercase tracking-widest hover:text-[#FFFF00] transition-colors">
              Cookie Policy
            </Link>
          </div>
        </div>
