    ...
    <section className="relative min-h-screen bg-[#2A1650] overflow-hidden flex items-center">
      ...
      <div className="relative z-10 container mx-auto px-6 py-32 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-screen lg:min-h-0 lg:py-32">
          ...
          <div className={`transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              <div className="flex items-center gap-2 bg-white/10 border border-white/20 px-4 py-2.5 rounded-2xl">
                <span className="text-lg">🤖</span>
                <div>
                  <p className="text-white font-black text-xs uppercase tracking-wide leading-none">AI Tutor</p>
          ...
          {/* ── RIGHT: Hero photo + floating stats ── */}
          <div className={`transition-all duration-1000 delay-300 hidden lg:block ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative">
              ...
              {/* Child learning photo */}
              <div className="rounded-[3rem] overflow-hidden border-4 border-white/10 shadow-2xl">
                <img
                  src="/hero-learning.png"
                  alt="Child learning with FricaLearn"
                  className="w-full h-[520px] object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2A1650]/50 to-transparent" />
              </div>

              {/* Floating stat cards */}
              <div className="absolute -left-8 top-10 bg-white rounded-2xl p-4 shadow-2xl">
              ...
              <div className="absolute left-6 -bottom-6 bg-[#3F2171] rounded-2xl px-5 py-4 shadow-2xl">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FFFF00] flex items-center justify-center text-xl">🤖</div>
                  <div>
