      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 relative">
          <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#2A1650]/40 to-transparent" />
          </div>
          {/* Decorative blob */}
          <div className="absolute -bottom-8 -left-8 w-72 h-72 bg-[#3F2171]/10 rounded-full -z-0 hidden md:block" />
          {/* Floating quote */}
          <div className="absolute bottom-10 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl z-20">
            <p className="text-[#2A1650] font-bold italic text-sm leading-relaxed mb-3">
              "We don't just teach words; we teach the etiquette, the proverbs,
              and the identity that comes with our mother tongues."
            </p>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-[#3F2171] rounded-full" />
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[#3F2171] font-black text-[10px] uppercase tracking-[0.4em]">Our Vision</span>
          </div>
          ...
          <h2 className="text-5xl md:text-6xl font-black uppercase italic tracking-tighter text-[#2A1650] leading-none mb-8">
            ...
            <span className="text-[#3F2171]">Modern Connection.</span>
          </h2>
          ...
          <div className="space-y-6">
            {[
              {
                num: "01", label: "Human-Centric Learning", color: "bg-[#3F2171]/10 text-[#3F2171]",
              ...
              {
                num: "02", label: "Dual Curriculum", color: "bg-[#FFFF00]/20 text-[#2A1650]",
              ...
              {
                num: "03", label: "Innovation for Tradition", color: "bg-[#2A1650]/10 text-[#2A1650]",
              ...
              <div key={item.num} className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-black text-[#2A1650] uppercase tracking-tight mb-1">{item.label}</h4>
