  ...
  const refreshData = async () => {
    try {
      if (isImpersonating && activeStudentId) {
        ...
        // response is the student User with student_profile nested
        setChildProfile(res.data?.student_profile ?? res.data);
      } else {
        // For direct student login, reload their profile
